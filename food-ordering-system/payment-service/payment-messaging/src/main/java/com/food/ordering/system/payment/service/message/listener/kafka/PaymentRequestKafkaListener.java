package com.food.ordering.system.payment.service.message.listener.kafka;

import com.food.ordering.system.domain.valueobject.PaymentOrderStatus;
import com.food.ordering.system.kafka.consumer.KafkaConsumer;
import com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel;
import com.food.ordering.system.payment.service.domain.ports.input.message.listener.PaymentRequestMessageListener;
import com.food.ordering.system.payment.service.message.mapper.PaymentMessagingDataMapper;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> messages,
        ...
        log.info("{} number of payments requests received with keys:{}, partitions:{}, offsets:{}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString());
        messages.forEach(paymentRequestAvroModel -> {
            if(PENDING == paymentRequestAvroModel.getPaymentOrderStatus()){
            ...
            } else if(CANCELLED == paymentRequestAvroModel.getPaymentOrderStatus()){
