...
public class RestaurantMessagingDataMapper {
    ...
    public RestaurantApprovalResponseAvroModel
    orderRejectedEventToRestaurantApprovalResponseAvroModel(OrderRejectEvent orderRejectEvent){
        return RestaurantApprovalResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
                ...
                .setOrderApprovalStatus(OrderApprovalStatus.valueOf(orderRejectEvent.
                        getOrderApproval().getApprovalStatus().name()))
                .setFailureMessages(orderRejectEvent.getFailureMessages())
                .build();
    }
